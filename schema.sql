...
CREATE TABLE IF NOT EXISTS `files` (
    ...
    `link_password_hash`  VARCHAR(255)          NULL DEFAULT NULL COMMENT 'bcrypt-Hash des Link-Passworts (optional)',
...
-- Rate-Limiting: speichert Upload-Versuche pro IP
CREATE TABLE IF NOT EXISTS `rate_limits` (
    `id`         INT UNSIGNED NOT NULL AUTO_INCREMENT,
    `ip`         VARBINARY(16) NOT NULL COMMENT 'IP-Adresse (inet6_aton)',
    `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- ALTER TABLE `files`
--     ADD COLUMN `link_password_hash` VARCHAR(255) NULL DEFAULT NULL
--     AFTER `email_recipient`;
-- CREATE TABLE IF NOT EXISTS `rate_limits` ( ... ); -- siehe oben
